...
**日本語** | [English](#english) | [Social preview 設定ガイド](docs/social-preview.md) | [GIF デモ構成案](docs/gif-demo.md)
...
**English** | [日本語](#e-hentai-ダウンロード-画像変換ツール) | [Social preview guide](docs/social-preview.md) | [GIF demo proposal](docs/gif-demo.md)
